      ...
      <div className="flex flex-col gap-6">
        ...
        <div className="rounded-[22px] bg-surface p-5 shadow-soft">
          <div className="relative max-w-sm mb-4">
            ...
            <Input value={search} onChange={(e) => setSearch(e.target.value)} placeholder="Buscar por nome, telefone ou CPF" className="pl-9" />
          </div>
            ...
            <table className="w-full text-[13px]">
              ...
              <tbody>
                ...
                {!isLoading && clients.length === 0 && (
                  <tr><td colSpan={4} className="py-10 text-center text-muted-foreground">Nenhum cliente cadastrado.</td></tr>
                )}
                {clients.map((c) => (
                    ...
                    <td className="py-3">
                      <div className="flex justify-end gap-1.5">
                        ...
                        <button
                          ...
                          className="h-8 w-8 rounded-full bg-muted grid place-items-center hover:bg-muted/70"
                          title="Editar"
                        >
                        ...
                        <button
                          onClick={() => askDelete(c)}
                          className="h-8 w-8 rounded-full bg-destructive/10 text-destructive grid place-items-center hover:bg-destructive/20"
                          title="Excluir"
                        >
